...
const tl = new TimelineMax({});
 ...
 if($(window).width()>975){
  tl.fromTo(header_items[0], 1,   {opacity: 0, y:-100},{opacity: 1, y: 0})
 ...
 setTimeout(function() {
    ...
    .fromTo($(".header_button"),1.5,{opacity:0, x: "50"},{opacity:1, x: "0"})
    .fromTo($(".article1__baner_text"), 1,{opacity:0, x: "-180"},{opacity:1, x: "0"})
    .fromTo($(".article1__text"), 1,{opacity:0, x: "180"},{opacity:1, x: "0"})
    .fromTo($(".article1__button"),1, {opacity:0, y:50},{opacity:1, y:0});
 }, 100);
